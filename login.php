      ...
      <div class="container">
        <div class="modal-login">
          ...
          <form class="modal-form" action="login.php" method="post">
            ...
            <button class="btn" name="entrar"><a href="account.html">Entrar</a></button><a class="forgot-psw" href="#">Esqueci minha senha!</a><span class="do-account">Ainda não tem cadastro? <a href="cadastro.php">Clique aqui</a></span>
          </form>
        </div>
